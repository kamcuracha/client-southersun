...
function hybrid_get_site_title() {
	...
	if ( $title = get_bloginfo( 'name' ) )
		$title = sprintf( '<a href="'. esc_url( home_url( '/' ) ) .'" %s rel="home"><span class="brand"><img src="'. trailingslashit( get_template_directory_uri() ) . 'assets/images/logo.png" alt="%s"></span><span class="brand-name">%s</span></a>', hybrid_get_attr( 'site-title' ), home_url(), $title );
